...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_CHAR_STATS, "INSERT INTO character_stats (guid, maxhealth, maxpower1, maxpower2, maxpower3, maxpower4, maxpower5, maxpower6, maxpower7, strength, agility, stamina, intellect, spirit, "
                     ...
                     "spellPower, resilience, min_damage, max_damage, min_r_damage, max_r_damage, base_attack_time, base_attack_time_r) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
	...
	// Unell .banlist char
	PrepareStatement(CHAR_SEL_CHARACTER_BANNED_ALL, "SELECT characters.guid, name FROM characters, character_banned WHERE characters.guid = character_banned.guid AND active = 1 GROUP BY characters.guid LIMIT 0, 50;", CONNECTION_SYNCH);
}
