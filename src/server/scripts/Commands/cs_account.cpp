...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        static std::vector<ChatCommand> accountSetCommandTable =
        {
            ...
            { "gmlevel", SEC_DEVELOPER, true, &HandleAccountSetGmLevelCommand, "" },
            { "password", SEC_DEVELOPER, true, &HandleAccountSetPasswordCommand, "" }
        };
        ...
        static std::vector<ChatCommand> accountCommandTable =
        {
            ...
            { "create", SEC_DEVELOPER, true, &HandleAccountCreateCommand, "" },
            { "delete", SEC_DEVELOPER, true, &HandleAccountDeleteCommand, "" },
            { "onlinelist", SEC_DEVELOPER, true, &HandleAccountOnlineListCommand, "" },
