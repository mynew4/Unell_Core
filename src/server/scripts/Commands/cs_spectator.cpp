...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "version",        SEC_DEVELOPER,        false, &HandleSpectatorVersionCommand,                  "" },
            { "reset",          SEC_DEVELOPER,        false, &HandleSpectatorResetCommand,                    "" },
            { "spectate",       SEC_DEVELOPER,        false, &ArenaSpectator::HandleSpectatorSpectateCommand, "" },
            { "watch",          SEC_DEVELOPER,        false, &ArenaSpectator::HandleSpectatorWatchCommand,    "" },
            { "leave",          SEC_DEVELOPER,        false, &HandleSpectatorLeaveCommand,                    "" },
            { "",               SEC_DEVELOPER,        false, &HandleSpectatorCommand,                         "" }
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "spect",          SEC_DEVELOPER,        false, nullptr,                                         "", spectatorCommandTable }
        };
        return commandTable;
    }
