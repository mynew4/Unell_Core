...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "delete",			SEC_DEVELOPER,			true,  &HandleCharacterDeletedDeleteCommand,	"" },
            ...
            { "old",			SEC_DEVELOPER,			true,  &HandleCharacterDeletedOldCommand,		"" },
        };
        ...
        static std::vector<ChatCommand> characterCommandTable =
        {
            ...
            { "erase",          SEC_DEVELOPER,			true,  &HandleCharacterEraseCommand,			"" },
