...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		...
		if (Unell_Script::Unell_accref(accid))
		{
			...
			if (refid != 1)
				player->ADD_GOSSIP_ITEM(10, "Узнать кто меня пригласил", GOSSIP_SENDER_MAIN, 2);
		}
...
public:
	...
	void OnLogin(Player* player)
	{
		...
		uint32 Killreward1 = sConfigMgr->GetIntDefault("Unell.Referer.System.Killreward1", 50);
		uint32 Killreward2 = sConfigMgr->GetIntDefault("Unell.Referer.System.Killreward2", 100);
		uint32 Killreward3 = sConfigMgr->GetIntDefault("Unell.Referer.System.Killreward3", 500);
		uint32 Timereward1 = sConfigMgr->GetIntDefault("Unell.Referer.System.Timereward1", 86400);
		uint32 Timereward2 = sConfigMgr->GetIntDefault("Unell.Referer.System.Timereward2", 259200);
		uint32 Timereward3 = sConfigMgr->GetIntDefault("Unell.Referer.System.Timereward3", 604800);
		
		uint32 Prizetonenkill1ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill1.Referer", 50);
		uint32 Prizetonenkill2ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill2.Referer", 100);
		uint32 Prizetonenkill3ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill3.Referer", 200);
		uint32 Prizetonentime1ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time1.Referer", 50);
		uint32 Prizetonentime2ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time2.Referer", 100);
		uint32 Prizetonentime3ref = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time3.Referer", 200);
		
		uint32 Prizetonenkill1 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill1", 100);
		uint32 Prizetonenkill2 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill2", 200);
		uint32 Prizetonenkill3 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Kill3", 400);
		uint32 Prizetonentime1 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time1", 100);
		uint32 Prizetonentime2 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time2", 200);
		uint32 Prizetonentime3 = sConfigMgr->GetIntDefault("Unell.Referer.System.Prizetonen.Time3", 400);
