...
// Unell System
// void AddSC_Unell_GO_System();
// void AddSC_Unell_Reforger_System();
...
void AddUnellScripts()
{
#ifdef SCRIPTS
	//~ AddSC_MySuperScript();
	// AddSC_Unell_Reforger_System();
	// AddSC_Unell_GO_System();
