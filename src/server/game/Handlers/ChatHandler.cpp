...
void WorldSession::HandleMessagechatOpcode(WorldPacket & recvData)
{
	...
	if (sender->isGMChat() && !msg.empty() && sender->GetSession()->GetSecurity() > 4)
		msg =  (sConfigMgr->GetStringDefault("Unell.GM.Chat.Color.Developer", "|cffFF0000")) + msg + "|r";
	
	if (sender->isGMChat() && !msg.empty() && sender->GetSession()->GetSecurity() > 0 && sender->GetSession()->GetSecurity() < 5)
		msg =  (sConfigMgr->GetStringDefault("Unell.GM.Chat.Color", "|cff14ECCF")) + msg + "|r";
