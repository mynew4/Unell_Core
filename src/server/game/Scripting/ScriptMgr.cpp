...
void ScriptMgr::OnGivePlayerHonorPoints(Player* player, float& amount, float& bonusPoints, Unit* victim)
{
	FOREACH_SCRIPT(PlayerScript)->OnGiveHonorPoints(player, amount, bonusPoints, victim);
}
