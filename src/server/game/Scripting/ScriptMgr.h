...
class PlayerScript : public ScriptObject
{
    ...
    public:
		...
		// Called when a player gains Honor Points (before anything is given)
		virtual void OnGiveHonorPoints(Player* /*player*/, float& /*amount*/, float& bonusPoints, Unit* /*victim*/) { }
...
class ScriptMgr
{
    ...
    public: /* PlayerScript */
		...
		void OnGivePlayerHonorPoints(Player* player, float& amount, float& bonusPoints, Unit* victim); // Unell Honor Reward
