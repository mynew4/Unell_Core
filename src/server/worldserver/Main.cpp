...
char serviceLongName[] = "UnellCore world service";
char serviceDescription[] = "UnellCore World of Warcraft emulator world service";
/*
...
UnellDatabaseWorkerPool UnellDatabase;                      ///< Accessor to the unell database
...
extern int main(int argc, char** argv)
{
    ...
    sLog->outString("Используется файл конфигурации %s.", cfg_file);
    sLog->outString("Используется SSL: %s (library: %s)", OPENSSL_VERSION_TEXT, SSLeay_version(SSLEAY_VERSION));
    sLog->outString("Используется ACE: %s", ACE_VERSION);
